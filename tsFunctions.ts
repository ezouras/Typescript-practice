...
function any_name(value: Number):Number{
  return value;
}
...
console.log(identity<String>("woot!"))
...
function idAndMessage<T,U>(id:T,message:U):T{
  console.log(message)
  return id;
}

console.log(idAndMessage<Number,String>(5,"hi!"))
...
//let level_of_difficulty:Difficulty = getProperty(typescript_info,"difficulty")
